...
(function(a, b, c, d) {
    ...
    (function() {
            ...
            return function(g, i, j, k) {
                ...
                (function() {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsQE"),
                        ...
                        e = f.getFbeventsModules("SignalsFBEventsDataProcessingOptionsConfigTypedef"),
                        g = f.getFbeventsModules("SignalsFBEventsTyped"),
                        i = g.coerce,
                        j = g.Typed;
                    g = f.getFbeventsModules("SignalsFBEventsOpenBridgeConfigTypedef");
                    var k = f.getFbeventsModules("SignalsFBEventsParallelFireConfigTypedef"),
                        m = f.getFbeventsModules("SignalsFBEventsLocalComputationConfigTypedef"),
                        o = f.getFbeventsModules("signalsFBEventsCoercePixelID"),
                        p = f.getFbeventsModules("signalsFBEventsCoerceBatchingConfig"),
                        q = f.getFbeventsModules("signalsFBEventsCoerceAutomaticMatchingConfig"),
                        r = f.getFbeventsModules("signalsFBEventsCoerceInferedEventsConfig"),
                        s = f.getFbeventsModules("SignalsFBEventsPCMInstagramTriggerAttributionConfigTypedef"),
                        t = f.getFbeventsModules("SignalsFBEventsLogging"),
                        u = t.logError,
                        v = "global",
                        w = {
                            automaticMatching: q,
                            ...
                            parallelfire: k,
                            pcmInstagramTriggerAttribution: s,
                            localcomputation: m
                        };
                    t = function() {
                        function b() {
                        ...
                        h(b, [{
                            ...
                            value: function(a, b, c) {
                                ...
                                this._configStore[b][a] = w[b] != null ? w[b](c) : c
                            }
                        }, {
                            key: "setExperimental",
                            value: function(b) {
                                b = i(b, j.objectWithFields({
                                    config: j.object(),
                            ...
                            key: "get",
                            value: function(a, b) {
                                return this._configStore[b][a != null ? a : v]
                            }
                        }, {
                            ...
                            value: function(a) {
                                u(new Error("Calling legacy api getAutomaticMatchingConfig"));
            ...
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsBaseEvent"),
                        ...
                        o = f.getFbeventsModules("SignalsFBEventsValidateCustomParametersEvent"),
                        p = f.getFbeventsModules("SignalsFBEventsValidateUrlParametersEvent"),
            ...
            return function(g, i, j, k) {
                ...
                (function() {
                    ...
                    var M = function(a, b, c, d, e) {
                        var f = new z(function(a) {
                            return a
                        });
                        f.append("v", b);
                        f.append("r", c);
                        d != null && d != "" && f.append("domain", d);
                        e != null && d != "" && f.append("fbc", e);
                        return o.CONFIG.CDN_BASE_URL + "signals/config/" + a + "?" + f.toQueryString()
                    };

                    function N(a, b, c, d, e) {
                        o.loadJSFile(M(a, b, c, d, e))
                    }
                    q = function() {
                        function d(a, b) {
                            var e = this;
                        ...
                        h(d, [{
                            ...
                            value: function(a) {
                                ...
                                if (!this.fbq.pendingConfigs || E(this.fbq.pendingConfigs, function(b) {
                                    ...
                                    N(a, this.VERSION, this.RELEASE_SEGMENT != null ? this.RELEASE_SEGMENT : "stable", d, this.getFBCWithAEMPayload())
                                }
                            }
                        }, {
                            key: "configLoaded",
        ...
        f.ensureModuleRegistered("SignalsFBEventsLocalComputationConfigTypedef", function() {
            return function(g, h, i, j) {
                var k = {
                    exports: {}
                };
                ...
                (function() {
                    ...
                    a = a.Typed;
                    a = a.objectWithFields({
                        conversionBitMappings: a.arrayOf(a.objectWithFields({
                        ...
                        eventRulesMappings: a.arrayOf(a.objectWithFields({
                            ruleGroupId: a.number(),
                            derivedEventName: a.string(),
                            transforms: a.number(),
                            condition: a.string()
                        })),
                        customConversionRulesMappings: a.arrayOf(a.objectWithFields({
                            conversionId: a.number(),
                            conversionRule: a.string()
                        })),
                        currencyRateMappings: a.arrayOf(a.objectWithFields({
        ...
        f.ensureModuleRegistered("SignalsFBEventsPCMInstagramTriggerAttributionConfigTypedef", function() {
            return function(g, h, i, j) {
                var k = {
                    exports: {}
                };
                ...
                (function() {
                    ...
                    a = a.Typed;
                    a = a.objectWithFields({
                        pcmInstagramTriggerAttributionURL: a.string()
                    });
                    k.exports = a
                })();
                return k.exports
        ...
        f.ensureModuleRegistered("signalsFBEventsSendEvent", function() {
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    var t = a.some;
                    a = f.getFbeventsModules("SignalsFBEventsTypes");
                    a.CustomData;
        ...
        f.ensureModuleRegistered("SignalsFBEventsTypes", function() {
            ...
            return function(f, g, j, k) {
                ...
                (function() {
                    ...
                    function u(a) {
                        ...
                        if (r)
                            for (var c = 0; c < t; c++) q.call(a, s[c]) && b.push(s[c]);
                        return b
                    }
        ...
        f.ensureModuleRegistered("SignalsParamList", function() {
            return function(f, g, j, k) {
                ...
                (function() {
                    ...
                    var f = function() {
                        function f(a) {
                            n(this, f), this._params = [], this._piiTranslator = a
                        }
                        h(f, [{
                            key: "containsKey",
                            value: function(a) {
                            ...
                            value: function(a) {
                                var b = 0;
                                while (b < this._params.length) this._params[b].name === a ? this._params.splice(b, 1) : b++
                            }
                        }, {
                            key: "_append",
            ...
            return function(a, b, c, d) {
                ...
                (function() {
                    ...
                    function la(a) {
                        ...
                        switch (a) {
                            ...
                            case "firstPartyCookies":
                                ...
                                typeof p === "string" ? V.callMethod([r, p, "FirstPartyCookies"]) : p === void 0 ? V.disableFirstPartyCookies = !0 : M({
                                    invalidParamName: "pixel_id",
                                    invalidParamValue: p,
                                    method: "set",
                                    params: e,
                            ...
                            case "pcmInstagramTriggerAttribution":
                                var C = c[0];
                                V.pluginConfig.set(C, "pcmInstagramTriggerAttribution", {
                                    pcmInstagramTriggerAttributionURL: k.INSTAGRAM_TRIGGER_ATTRIBUTION
                                });
                                break;
                            case "trackSingleOnly":
                                ...
                                var H = q.validateMetadata(a);
                                H.error && M(H.error);
                                H.warnings && H.warnings.forEach(function(a) {
                                    M(a)
                                });
                                P.call(T, G) ? T[G].trackSingleOnly = F : M({
                                    metadataValue: a,
                                    pixelID: G,
                                ...
                                break;
                            default:
                                var I = V.pluginConfig.getWithGlobalFallback(null, "dataProcessingOptions"),
                    ...
                    function Y(a, b, c) {
                        ...
                        if (P.call(T, d)) {
                            b != null && D(T[d].userData) ? (T[d].userData = e ? b || {} : {}, W.loadPlugin("identity")) : M({
                                pixelID: d,
                    ...
                    function oa(a, b, c) {
                        b = b || {}, q.validateEventAndLog(a, b), a === "CustomEvent" && typeof b.event === "string" && (a = b.event), Z.call(this, a, b, c)
                    }

                    function Z(a, b, c) {
                        for (var d = 0, e = S.length; d < e; d++) {
                            var f = S[d];
                            if (!(a === "PageView" && this.allowDuplicatePageViews) && Object.prototype.hasOwnProperty.call(U, a) && U[a].has(f.id)) continue;
                    ...
                    function ra(a, b, c, d) {
                        ...
                        try {
                            var g = a && a.userData || {},
                                ...
                                k = {},
                                l = void 0;
                            g.em != null && $(g.em) && (l = $(g.em), l === 1 && (i.em = fa));
                            h.em != null && $(h.em) && (l = $(h.em), l === 1 && (k.em = fa));
                        ...
                        e.append("it", O);
                        g = a && a.codeless === "false";
                        e.append("coo", g);
                        i = V.pluginConfig.getWithGlobalFallback(a ? a.id : null, "dataProcessingOptions");
                        if (i != null) {
                            h = i.dataProcessingCountry;
                            k = i.dataProcessingOptions;
                            b = i.dataProcessingState;
                            e.append("dpo", k.join(","));
                            e.append("dpoco", h);
                            e.append("dpost", b)
                        }
                    ...
                    function ya(a) {
                        a.instance = V, a.callMethod = X, a._initHandlers = [], a._initsDone = {}, a.send = qa, a.getEventCustomParameters = ra, a.addInitHandler = wa, a.getState = xa, a.init = Y, a.set = la, a.loadPlugin = function(a) {
